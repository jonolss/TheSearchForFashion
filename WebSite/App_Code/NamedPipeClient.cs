...
namespace NamedPipeTest
{
    class NamedPipeClient
    {
        ...
        private static IntPtr mutexSema;
        private static IntPtr syncSema;
        private static IntPtr clientHandleIN;
        private static IntPtr clientHandleOUT;
        ...
        public string Run(string msg)
        {
            ...
            //    return "CreateMutexSemaphore error: " + GetLastError();
            //}
